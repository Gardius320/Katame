...
export const es = {
  ...
  forgotPassword: {
    ...
    submitting: 'Enviando...',
    successMessage:
      'Si el correo está registrado, vas a recibir un enlace para restablecer tu contraseña. Revisá tu bandeja de entrada (y la de spam).',
  ...
  resetPassword: {
    ...
    successMessage: 'Tu contraseña se actualizó. Ya podés iniciar sesión.',
    invalidLinkMessage: 'Este enlace de recuperación no es válido o ya expiró. Pedí uno nuevo.',
  ...
  register: {
    title: 'Crear cuenta',
    subtitle: 'Registrate para empezar a usar Katame',
    firstNameLabel: 'Nombre',
    firstNamePlaceholder: 'Ej. Ana',
    lastNameLabel: 'Apellido',
    lastNamePlaceholder: 'Ej. Pérez',
    documentIdLabel: 'Cédula',
    documentIdPlaceholder: 'Ej. 1701234567',
    emailLabel: 'Correo',
    emailPlaceholder: 'Ej. ana@correo.com',
    phoneNumberLabel: 'Teléfono',
    phoneNumberPlaceholder: 'Ej. 0991234567',
    passwordLabel: 'Contraseña',
    confirmPasswordLabel: 'Nuevamente contraseña',
    ...
    validation: {
      ...
      documentIdInvalid: 'Ingresa una cédula ecuatoriana válida.',
      emailRequired: 'El correo es obligatorio.',
      emailInvalid: 'Ingresa un correo válido.',
      phoneNumberRequired: 'El teléfono es obligatorio.',
      phoneNumberInvalid: 'Ingresa un teléfono ecuatoriano válido (celular: 09XXXXXXXX, fijo: 0X XXXXXXX).',
      passwordRequired: 'La contraseña es obligatoria.',
      passwordMinLength: 'La contraseña debe tener al menos 8 caracteres.',
      confirmPasswordRequired: 'Confirma la contraseña.',
      passwordsDontMatch: 'Las contraseñas no coinciden.',
  ...
  users: {
    ...
    regular: 'Usuario',
    createdAt: 'Creado',
    deleteDisabledSelf: 'No podés eliminar tu propia cuenta.',
    deleteDisabledLastAdmin: 'No podés eliminar al último administrador.',
    fields: {
